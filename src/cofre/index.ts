...
export * from './sync.js'
export * from './syncCofre.js'
export * from './config.js'
export * from './sessaoLembrada.js'
export { VaultGate } from './VaultGate.js'
export { UnlockMethods } from './UnlockMethods.js'
export { PasskeyDoctor } from './PasskeyDoctor.js'
