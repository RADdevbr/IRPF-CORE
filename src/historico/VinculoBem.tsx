...
import { candidatosPara, LIMIAR, type Candidato } from './vinculoAuto.js'
import { resolverCadeias, serieDaPosicao, type Historico as Hist, type PosicaoAno, type Vinculos } from './historico.js'
